...
FindInfraWalk::usage = "FindInfraWalk[graph, p1, p2, kspec] gives the walks from p1 to p2 of length restricted by kspec (k, {k}, {kmin, kmax}, Infinity) in the class cut by the Properties rules; the default {\"Generic\"} is the generic immersed walks, every multiple point an isolated crossing. Options Properties, Method, \"Crossings\" (legacy exact crossing count).";
