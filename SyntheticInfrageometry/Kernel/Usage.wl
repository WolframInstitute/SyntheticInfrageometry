...
FindInfraWalk::usage = "FindInfraWalk[graph, p1, p2, kspec] gives non-backtracking walks from p1 to p2 of length restricted by kspec (k, {k}, {kmin, kmax}, Infinity) with exactly \"Crossings\" -> c arrivals at an already-visited vertex; c = 0 (default) is the simple paths, c >= 1 is drawn at random as lassos (finite kspec required). Options \"Crossings\", Method.";
