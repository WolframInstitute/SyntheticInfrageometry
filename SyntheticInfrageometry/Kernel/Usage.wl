...
ExtendInfraGeodesic::usage = "ExtendInfraGeodesic[graph, seed, scale, kspec] continues a seed walk under the geodesic rules at infra-scale scale until a stopping condition or the budget kspec (edges added to the seed) stops it. Options Properties, \"StoppingCondition\", Method, \"Direction\".";
