...
FindInfraWalk::usage = "FindInfraWalk[graph, p1, p2, kspec] gives walks from p1 to p2 of length restricted by kspec (k, {k}, {kmin, kmax}, Infinity), simple by default; \"Simple\" -> False gives non-backtracking walks with a self-intersection, drawn at random (finite kspec required). Options \"Simple\", Method.";
