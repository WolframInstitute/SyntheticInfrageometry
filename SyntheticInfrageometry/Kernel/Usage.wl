...
(* Tessellations *)
TorusTessellation::usage = "TorusTessellation[{n, m}, {p, q}] glues copies of CycleGraph[p] into a torus graph in which q polygons meet at each vertex, on an n x m rectangular fundamental-domain grid. (p, q) is a Schlafli symbol; the flat-torus Euler relation 1/p + 1/q = 1/2 admits exactly three integer solutions, giving the three vertex-transitive cases: {3, 6} (triangles, V = n m, E = 3 n m, F = 2 n m, valency 6), {4, 4} (squares, V = n m, E = 2 n m, F = n m, valency 4), {6, 3} (hexagons, V = 2 n m, E = 3 n m, F = n m, valency 3). Other (p, q) -- spherical {3,3}, {3,4}, {4,3}, {3,5}, {5,3} or hyperbolic {5,4}, {7,3}, ... -- are rejected with TorusTessellation::nontorus. TorusTessellation[{n, m}, p] is shorthand for {p, 2 p / (p - 2)}; TorusTessellation[n, ...] is shorthand for {n, n}.";
