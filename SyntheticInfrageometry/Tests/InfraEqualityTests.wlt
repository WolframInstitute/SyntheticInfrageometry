...
VerificationTest[
  InfraEqualQ[ PathGraph[ Range[ 7 ] ], InfraPoint[ { 3, 4 } ], InfraPoint[ { 4, 5 } ] ],
  False,
  TestID -> "InfraEqualQ-Point-half-overlap-Diffuse-False"
]

VerificationTest[
  InfraEqualQ[ PathGraph[ Range[ 7 ] ], InfraPoint[ { 3, 4, 5 } ], InfraPoint[ { 4, 5 } ] ],
  True,
  TestID -> "InfraEqualQ-Point-majority-overlap-Diffuse-True"
]

VerificationTest[
  InfraEqualQ[ PathGraph[ Range[ 7 ] ], InfraPoint[ { 3, 4 } ], InfraPoint[ { 4, 5 } ], Method -> "Overlap" ],
  True,
  TestID -> "InfraEqualQ-Point-half-overlap-Overlap-True"
]

VerificationTest[
  InfraEqualQ[ PathGraph[ Range[ 7 ] ], InfraPoint[ { 1, 2 } ], InfraPoint[ { 6, 7 } ], Method -> "Overlap" ],
  False,
  TestID -> "InfraEqualQ-Point-disjoint-Overlap-False"
]

VerificationTest[
  InfraEqualQ[ PathGraph[ Range[ 7 ] ], InfraPoint[ { 3, 4, 5 } ], InfraPoint[ { 5, 4, 3 } ], Method -> "Set" ],
  True,
  TestID -> "InfraEqualQ-Point-permuted-Set-True"
]

VerificationTest[
  InfraEqualQ[ PathGraph[ Range[ 7 ] ], InfraPoint[ { 3, 4, 5 } ], InfraPoint[ { 5, 4, 3 } ], Method -> "Multiset" ],
  True,
  TestID -> "InfraEqualQ-Point-permuted-Multiset-True"
]

VerificationTest[
  InfraEqualQ[ PathGraph[ Range[ 7 ] ], InfraPoint[ { 3, 4, 4 } ], InfraPoint[ { 3, 4 } ], Method -> "Multiset" ],
  False,
  TestID -> "InfraEqualQ-Point-multiplicity-mismatch-Multiset-False"
]

VerificationTest[
  InfraEqualQ[ PathGraph[ Range[ 7 ] ], InfraPoint[ { 3, 4, 4 } ], InfraPoint[ { 3, 4 } ], Method -> "Set" ],
  True,
...
VerificationTest[
  InfraEqualQ[ GridGraph[ { 3, 3 } ],
    First @ FindInfraSegment[ GridGraph[ { 3, 3 } ], 1, 9 ],
    First @ FindInfraSegment[ GridGraph[ { 3, 3 } ], 1, 9 ] ],
  True,
...
VerificationTest[
  Module[ { g = PathGraph[ Range[ 7 ] ],
    ...
    AllTrue[ {
      ...
      check[ g, InfraPoint[ { 3, 4 } ], InfraPoint[ { 4, 5 } ] ],
      check[ g, InfraPoint[ { 3, 4, 5 } ], InfraPoint[ { 4, 5 } ] ],
      check[ g, InfraPoint[ { 3, 4, 4 } ], InfraPoint[ { 3, 4 } ] ],
